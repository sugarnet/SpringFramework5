...
public class FormController {
	...
	public void initDataBinder(WebDataBinder binder) {
		...
		// validate only birthDate field in form and allow empty (parameter in CustomDateEditor)
	...
	public String process(@Valid User user, BindingResult bindingResult, Model model, SessionStatus sessionStatus) {
		// we user ModelAttribute when need change the name of attribute used in the template against the controller
	// public String process(@Valid @ModelAttribute("usuario") User user, BindingResult bindingResult, Model model) {
